...
public class GuessTheNumberUI {
    ...
    private JPanel makeCardsPanel(){
        ...
        JPanel humanGuessesPanel = new HumanGuessesPanel(cardsPanel, gameResult -> {gameOverPanel.setGameResults(gameResult, StatsFile.FILENAME);});
        ...
        // COMPUTER_PLAY
        JPanel computerGuessesPanel = new ComputerGuessesPanel(cardsPanel, gameResult -> {gameOverPanel.setGameResults(gameResult, StatsFile.FILENAME);});
